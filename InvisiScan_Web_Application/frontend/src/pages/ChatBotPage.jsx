  ...
  const handleSendMessage = async () => {
    ...
    {isTyping && (
      <div className="self-start bg-gray-300 text-gray-800 p-3 rounded-lg w-fit max-w-[75%] shadow-md">
        <span className="animate-pulse">InvisiScan is typing...</span>
      </div>
    )}
  ...
  return (
    <div className="flex flex-col lg:flex-row items-center justify-center min-h-screen bg-gray-900 p-6 space-y-6 lg:space-y-0 lg:space-x-8">
      <div className="flex flex-col items-center flex-1">
        <img src="etherium.png" alt="InvisiScan Logo" className="w-24 h-auto object-contain mb-2" />
        <div className="text-4xl font-extrabold tracking-wide text-center">
          <span className="bg-gradient-to-t from-green-400 via-green-500 to-green-600 bg-clip-text text-transparent">INVISI</span>{" "}
          <span className="bg-gradient-to-b from-green-400 via-green-500 to-green-600 bg-clip-text text-transparent">SCAN</span>
        </div>

        <Player autoplay loop src="Chatbot.json" className="w-48 h-48 my-4" />
        <p className="text-gray-300 text-lg max-w-md text-center">Hey! I'm InvisiScan, How can I help you?</p>
          ...
          {isChatExpanded ? (
            <>
              <div className="bg-gray-900 p-3 flex justify-between items-center">
                <p className="text-gray-300 text-sm">InvisiScan Chatbot</p>
